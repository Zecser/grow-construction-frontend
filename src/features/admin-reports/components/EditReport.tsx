...
const EditReportPage: React.FC<EditReportPageProps> = ({ report: initialReport, onBack }) => {
  const { report, handleChange, handleSubmit , loading} = useEditReport(initialReport, onBack);
    ...
    <div className="p-4 md:p-8 max-w-5xl mx-auto">
      ...
      <form onSubmit={handleSubmit} className="space-y-4 text-sm md:text-base">
        ...
        <div className="grid grid-cols-2 gap-4 text-xs">
          <div>
            <label className="block text-primary font-medium mb-1">Status</label>
            <select
              value={report.status}
          ...
          <div>
            ...
            <input
              ...
              className="w-full h-10 border border-gray-300 rounded-lg focus:outline-none focus:ring-1 focus:ring-primary px-2 py-1 text-xs md:text-sm"
            />
          </div>
        </div>
        ...
        <div className="grid grid-cols-2 gap-4 text-xs">
          ...
          <div>
            <label className="block text-primary font-medium mb-1">Deadline</label>
            <input
              type="date"
        ...
        <div className="grid grid-cols-2 gap-4 text-xs">
          ...
          <div>
            <label className="block text-primary font-medium mb-1">Location</label>
            <input
              type="text"
        ...
        <div>
          ...
          <select
            ...
            className="w-full h-10 border border-gray-300 rounded-lg focus:outline-none focus:ring-1 focus:ring-primary px-3 py-2 text-xs md:text-sm"
          >
